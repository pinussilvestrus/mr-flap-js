...
class Canvas {
  ...
  collisionDetection () {
    ...
    const birdShape = this.bird.shape;
    const obstacles = this.obstacles;
    const birdWidth = birdShape.x + birdShape.width;
    ...
    obstacles.forEach(obstacle => {
      ...
      const obstacleShape = obstacle.shape;
      const obstacleHeight = obstacleShape.y + obstacleShape.height;
      const obstacleWidth = obstacleShape.x + obstacleShape.width;
